 ...
 *
 * @Route("/admin/food", name="admin_food_")
 *
...
class FoodController extends AbstractController
{
                          ...
                          DatatableFieldInterface $datatableField): Response
    {
        ...
        $datatableField
            ->addCreatedBy($table)
            ->addDeleteField($table, 'admin/food/include/_delete-button.html.twig', [
                'entity'         => 'food',
        ...
        $datatableField->createDatatableAdapter($table, Prestation::class, 'a.type = :food');
    ...
    public function delete(Prestation $prestation): Response
    {
        ...
        return new JsonResponse([
            'type'    => 'success',
            'message' => 'L\'aliment a été supprimé avec succès'
        ], 200);
    }
}