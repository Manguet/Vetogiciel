...
class ClientControllerTest extends WebTestCase
{
    ...
    {
        $this->client->request('GET', '/admin/user/show/');
    ...
    public function testShowWithVeterinary(): void
    {
        ...
        $user = $entityManager->getRepository(Client::class)
            ->findOneBy([]);

        $this->client->request('GET', '/admin/user/show/' . $user->getId());
    ...
    public function testEditWithVeterinary(): void
    {
        ...
        $this->client->request('GET', '/admin/user/edit/' . $user->getId());
